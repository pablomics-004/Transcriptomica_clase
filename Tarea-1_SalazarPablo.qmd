...
Entre muestras, el tiempo de alineamiento pareciera crecer a medida que crece el número de lecturas, aunque esta tendencia no es completamente lineal como se puede ver en el panel derecho de la **Figura 3**, en donde las muestras están ordenadas ascendentemente en función del número de lecturas. Esto podría deberse a variaciones en la complejidad del genoma de referencia, la calidad de las lecturas, la presencia de secuencias repetitivas que pueden afectar el tiempo de alineamiento o la propia naturaleza de los algoritmos que, aunque con tendencias similares, de nuevo STAR refleja un mejor desempeño en términos de tiempo de ejecución tanto para PE como SE.
